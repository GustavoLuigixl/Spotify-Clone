...
export function SpotifyArtistaParaArtista(spotifyArtistas: SpotifyApi.ArtistObjectFull): IArtista{
  return{
    id: spotifyArtistas.id,
    imagemUrl: spotifyArtistas.images.sort((a,b)=> a.width - b.width).pop().url,
    nome: spotifyArtistas.name
  };
}
